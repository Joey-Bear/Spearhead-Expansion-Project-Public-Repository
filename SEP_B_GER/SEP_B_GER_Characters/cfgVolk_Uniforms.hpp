	...
	class SEP_B_GER_U_Suit_Swetr_Brn_CFV: SPE_FFI_Jacket_bruin_swetr
	{
		author="Joe";
		scope= 1;
		scopeArsenal=2;
	...
	class SEP_B_GER_U_Suit_Gry_CFV: SPE_FFI_Jacket_grijs
	{
		author="Joe";
		scope= 1;
		scopeArsenal=2;
	...
	class SEP_B_GER_U_Suit_Blk_CFV: SPE_FFI_Jacket_zwart
	{
		author="Joe";
		scope= 1;
		scopeArsenal=2;
	...
	class SEP_B_GER_U_Coverall_Blu_CFV: SPE_CIV_Worker_Coverall_2
	{
		author="Joe";
		scope= 1;
		scopeArsenal=2;
	...
	class SEP_B_GER_U_Casual_1_CFV: SPE_FFI_Casual_7
	{
		author="Joe";
		scope= 1;
		scopeArsenal=2;
	...
	class SEP_B_GER_U_Casual_2_CFV: SPE_FFI_Casual_7
	{
		author="Joe";
		scope= 1;
		scopeArsenal=2;
