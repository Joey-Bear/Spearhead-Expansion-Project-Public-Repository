...
class SEP_B_GER_H_PithHelmet_LW: SEP_B_GER_H_PithHelmet
{
    ...
    picture = "\SEP\SEP_B_GER\SEP_B_GER_Characters\data\icons\SEP_B_GER_H_PithHelmet_LW_ca.paa";
    scope = 2;
    hiddenSelectionsTextures[] = 
    {
        "SEP\SEP_B_GER\SEP_B_GER_Characters\Data\SEP_B_GER_H_PithHelmet_LW_CO.paa"
    };
};
...
class SEP_B_GER_H_PithHelmet_ns_LW: SEP_B_GER_H_PithHelmet_ns
{
    ...
    picture = "\SEP\SEP_B_GER\SEP_B_GER_Characters\data\icons\SEP_B_GER_H_PithHelmet_ns_LW_ca.paa";
    scope = 2;
    hiddenSelectionsTextures[] = 
    {
        "SEP\SEP_B_GER\SEP_B_GER_Characters\Data\SEP_B_GER_H_PithHelmet_LW_CO.paa"
...
class SEP_B_GER_LW_U_Mantel : Uniform_Base
{
    ...
    picture = "\SEP\SEP_B_GER\SEP_B_GER_Characters\data\icons\SEP_B_GER_LW_U_Mantel_ca.paa";
...
class SEP_B_GER_LW_U_Mantel_Gaiters : Uniform_Base
{
	...
	hiddenSelections[] = {"camo"};
	hiddenSelectionsTextures[] = {"\WW2\SPE_Assets_t\Characters\Germans_t\suitpacks\suitpack_de_feldbluse_co.paa"};
    picture = "\SEP\SEP_B_GER\SEP_B_GER_Characters\data\icons\SEP_B_GER_LW_U_Mantel_Gaiters_ca.paa";
    class ItemInfo: UniformItem
    {
        uniformModel= "-";
