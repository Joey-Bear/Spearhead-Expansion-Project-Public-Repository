...
class SEP_B_GER_H_Stahlhelm_WIN_1_utility_ns : H_SPE_GER_HelmetUtility_OS
{
    author = "OokamiJamie";
    scope = 2;
    weaponPoolAvailable = 1;
...
class SEP_B_GER_H_Stahlhelm_WIN_2 : H_SPE_GER_Helmet
{
    author = "OokamiJamie";
    scope = 2;
    weaponPoolAvailable = 1;
...
class SEP_B_GER_H_Stahlhelm_WIN_2_utility_ns : H_SPE_GER_HelmetUtility_OS
{
    author = "OokamiJamie";
    scope = 2;
    weaponPoolAvailable = 1;
...
class SEP_B_GER_H_StahlhelmM40_WIN_1 : H_SPE_GER_Helmet_M40
{
    author = "OokamiJamie";
    scope = 2;
    weaponPoolAvailable = 1;
...
class SEP_B_GER_H_StahlhelmM40_WIN_1_utility_ns : H_SPE_GER_Helmet_M40Utility_OS
{
    author = "OokamiJamie";
    scope = 2;
    weaponPoolAvailable = 1;
...
class SEP_B_GER_H_StahlhelmM40_WIN_1_net : H_SPE_GER_Helmet_M40_net
{
    author = "OokamiJamie";
    scope = 2;
    weaponPoolAvailable = 1;
...
/* Hidden
class SEP_B_GER_H_StahlhelmCover_win : H_SPE_GER_HelmetCamo
{
    author = "OokamiJamie";
    scope = 1;
    weaponPoolAvailable = 1;
...
*/
class SEP_B_GER_H_StahlhelmCover_maus : H_SPE_GER_HelmetCamo
{
    author = "OokamiJamie";
    scope = 2;
    weaponPoolAvailable = 1;
...
// Uniforms (CfgWeapons)
class SEP_B_GER_U_Parka_grau : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Parka_grau_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};
class SEP_B_GER_U_Parka_grau_mix : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Parka_grau_mix_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};
class SEP_B_GER_U_Parka_wht : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Parka_wht_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};
class SEP_B_GER_U_Parka_wht_mix : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Parka_wht_mix_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};
class SEP_B_GER_U_Parka_grau_mix_uffz : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Parka_grau_mix_uffz_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};
class SEP_B_GER_U_Parka_sumpf : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Parka_sumpf_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_FieldUniform_M44 : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_FieldUniform_M44_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_FieldUniform_M44_Open : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_FieldUniform_M44_Open_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_FieldUniform_M44_Open_Gref : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_FieldUniform_M44_Open_Gref_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_FieldUniform_M44_Roll : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    displayName = "GER Field Uniform 1944 (Rolled)";
    descriptionShort = "";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
	hiddenSelections[] = {"camo"};
	hiddenSelectionsTextures[] = {"\WW2\SPE_Assets_t\Characters\Germans_t\suitpacks\suitpack_de_feldbluse_co.paa"};
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_FieldUniform_M44_Roll_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_FieldUniform_M44_Unbloused : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    displayName = "GER Field Uniform 1944 (Unbloused)";
    descriptionShort = "";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
	hiddenSelections[] = {"camo"};
	hiddenSelectionsTextures[] = {"\WW2\SPE_Assets_t\Characters\Germans_t\suitpacks\suitpack_de_feldbluse_co.paa"};
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_FieldUniform_M44_Unbloused_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_FieldUniform_M44_Uffz : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_FieldUniform_M44_Uffz_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_FieldUniform_M44_Open_Uffz : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    displayName = "GER Field Uniform 1944 (Opened, Unteroffizier)";
    descriptionShort = "";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
	hiddenSelections[] = {"camo"};
	hiddenSelectionsTextures[] = {"\WW2\SPE_Assets_t\Characters\Germans_t\suitpacks\suitpack_de_feldbluse_co.paa"};
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_FieldUniform_M44_Open_Uffz_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_FieldUniform_M44_Roll_Uffz : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_FieldUniform_M44_Roll_Uffz_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_FieldUniform_M44_Ober : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_FieldUniform_M44_Ober_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_FieldUniform_M44_Roll_Gref : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_FieldUniform_M44_Roll_Gref_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_Mantel_M36 : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Mantel_M36_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_Mantel_M36_Gaiters : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Mantel_M36_Gaiters_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_Mantel_M36_Uffz : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Mantel_M36_Uffz_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_Mantel_M40 : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Mantel_M40_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_Mantel_M40_Gaiters : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Mantel_M40_Gaiters_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_Mantel_M40_Unbloused : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Mantel_M40_Unbloused_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_Mantel_M40_Uffz : Uniform_Base
{
    author = "Jamie";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Mantel_M40_Uffz_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};

class SEP_B_GER_U_Mantel_M40_Lehr : Uniform_Base
{
    author = "Jamie, Joe";
    scope = 2;
    ...
    {
        uniformModel= "-";
        uniformClass= "SEP_B_GER_U_Mantel_M40_Lehr_CFV";
        containerClass= "Supply50";
        mass=20;
    };
};