...
class SEP_B_GER_WIN_Nashorn : SPE_Nashorn 
{
	...
	{
		class MainTurret : MainTurret { gunnerType = "SEP_B_GER_WIN_SPG Crew"; };
		class kurs_MG_turret : kurs_MG_turret { gunnerType = "SEP_B_GER_WIN_SPG Crew"; };
		class CommanderOptics : CommanderOptics { gunnerType = "SEP_B_GER_WIN_SPG_Unterofficer"; };
		class Loader_place : Loader_place { gunnerType = "SEP_B_GER_WIN_SPG Crew"; };
	};
};