...
class SEP_B_GER_Sturm_WIN_PzKpfw_III_J : SPE_PzKpfwIII_J 
{
	author = "Jamie";
	editorSubCategory = "EdSubcat_Tanks";
	scope = 2;
...
class SEP_B_GER_Sturm_WIN_PzKpfw_III_L : SPE_PzKpfwIII_L 
{
	author = "Joe";
	editorSubCategory = "EdSubcat_Tanks";
	scope = 2;
...
class SEP_B_GER_DAK_PzKpfw_III_M : SPE_PzKpfwIII_M 
{
	...
	class Turrets : Turrets
	{
		class MainTurret : MainTurret
		{
			gunnerType = "SPEX_GER_DAK_Pz_crew";
			class Turrets : Turrets
			{
				class CommanderOptics : CommanderOptics { gunnerType = "SPEX_GER_DAK_Pz_SquadLead"; };
				class Loader_place : Loader_place { gunnerType = "SPEX_GER_DAK_Pz_crew"; };
			};
		};
		class kurs_MG_turret : kurs_MG_turret {};
		class CargoTurret_01 : CargoTurret_01 {};
...
class SEP_B_GER_Sturm_WIN_PzKpfw_III_M : SPE_PzKpfwIII_M 
{
	author = "Joe";
	editorSubCategory = "EdSubcat_Tanks";
	scope = 2;
...
class SEP_B_GER_Sturm_WIN_PzKpfw_III_N : SPE_PzKpfwIII_N 
{
	author = "Joe";
	editorSubCategory = "EdSubcat_Tanks";
	scope = 2;
