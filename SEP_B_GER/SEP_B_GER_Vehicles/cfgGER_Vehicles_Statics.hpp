...
class SEP_B_GER_WIN_leFH18: SPE_leFH18
{
	...
	class Turrets : Turrets
	{
		...
		class CommanderOptics: CommanderOptics
		{
			gunnerType = "SEP_B_GER_WIN_Gun_Lieutenant";
		};
		class CargoTurret_01: CargoTurret_01
		{
			gunnerType = "SEP_B_GER_WIN_Gun_Crew";
	...
	class TextureSources
	{
		class SEP_B_GER_Panzergrau
		{
			...
			factions[] = 
			{
				...
				"SPE_STURM",
				"SEP_B_GER_DAK_Units",
				"SEP_B_GER_Winter_Units",
				"SEP_B_GER_Sturm_Winter_Units",
				"SEP_B_FAR_Units",
				"SEP_B_FAR_WIN_Units"
			};
		};
...
class SPE_Pak40: SPE_Pak40_base
{
	scope=2;
	scopeCurator=2;
	dlc = "SPE";
	...
	editorSubcategory = "EdSubcat_Turrets";
	crew = "SPE_GER_gun_crew";
	displayName = "PaK 40";
	editorPreview = "\WW2\SPE_Core_t\EditorPreviews_t\SPE_Pak40.jpg";
	textureList[] = {};
	hiddenSelectionsTextures[] = {"\WW2\SPE_Assets_t\Vehicles\StaticWeapons_t\Pak40\PAK_40_Camo6_co.paa"};
	icon = "\WW2\SPE_Assets_t\Vehicles\Icons_t\Icon_Pak40_ca.paa";
	class Turrets : Turrets
	{
		class MainTurret : MainTurret
		{
			...
			gunnerType = "SPE_GER_gun_crew";
		};
		class CommanderOptics: CommanderOptics
		{
			gunnerType = "SPE_GER_gun_lieutenant";
		};
		class CargoTurret_01: CargoTurret_01
		{
			gunnerType = "SPE_GER_gun_crew";
		...
		class CargoTurret_02: CargoTurret_02
		{
			gunnerType = "SPE_GER_gun_SquadLead";
		};
		class CargoTurret_03: CargoTurret_03
		{
			gunnerType = "SPE_GER_gun_crew";
...
class SPEX_DAK_Pak40: SPE_Pak40
{
	scope=2;
	scopeCurator=2;
	dlc = "SPE";
	...
	editorSubcategory = "EdSubcat_Turrets";
	crew = "SPEX_GER_DAK_gun_crew";
	displayName = "PaK 40";
	editorPreview = "\WW2\SPEX\addons\assets_t_vehicles_editorpreviews_t\SPEX_DAK_Pak40.jpg";
	textureList[] = {};
	hiddenSelectionsTextures[] = {"\WW2\SPEX\addons\assets_t_vehicles_staticweapons_t\Pak40\PAK_40_dak_camo3_co.paa"};
	icon = "\WW2\SPE_Assets_t\Vehicles\Icons_t\Icon_Pak40_ca.paa";
	class Turrets : Turrets
	{
		class MainTurret : MainTurret
		{
			...
			gunnerType = "SPEX_GER_DAK_gun_crew";
		};
		class CommanderOptics: CommanderOptics
		{
			gunnerType = "SPE_GER_gun_lieutenant";
...
class SEP_B_GER_Sturm_WIN_leFH18: SPE_leFH18
{
	...
	class Turrets : Turrets
	{
		class MainTurret : MainTurret
		{
			...
			gunnerType = "SEP_B_GER_Sturm_WIN_Rflmn_K98";
		};
		class CommanderOptics: CommanderOptics
		{
			gunnerType = "SEP_B_GER_Sturm_WIN_Untersturmfuhrer";
		};
		class CargoTurret_01: CargoTurret_01
		{
			gunnerType = "SEP_B_GER_Sturm_WIN_Rflmn_K98";
		...
		class CargoTurret_02: CargoTurret_02
		{
			gunnerType = "SEP_B_GER_Sturm_WIN_SL";
		};		
	};
};

class SEP_B_GER_Sturm_WIN_leFH18_AT: SPE_leFH18_AT
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
...
class SEP_B_GER_Sturm_WIN_GrW278_1 : SPE_GrW278_1
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
...
class SEP_B_GER_Sturm_WIN_FlaK_36_AA: SPE_FlaK_36_AA
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
...
class SEP_B_GER_Sturm_WIN_FlaK_38: SPE_FlaK_38
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
...
class SEP_B_GER_Sturm_WIN_SearchLight : SPE_GER_SearchLight
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
...
class SEP_B_GER_Volk_GrW278_1 : SPE_GrW278_1
{
	...
	displayName = "8.14 cm GrW 278/1 (f)";
	editorPreview = "\WW2\SPE_Core_t\EditorPreviews_t\SPE_GrW278_1.jpg";
};

class SEP_B_GER_Volk_MG34_Lafette_Deployed: SPE_MG34_Lafette_Deployed
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
...
class SEP_B_GER_Volk_MG34_Bipod : SPE_MG34_Bipod
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
...
class SEP_B_GER_Volk_MG34_Lafette_low_Deployed : SPE_MG34_Lafette_low_Deployed
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
...
class SEP_B_GER_Volk_MG34_Lafette_Trench_Deployed : SPE_MG34_Lafette_Trench_Deployed
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
...
class SEP_B_GER_Volk_Pak40: SPE_Pak40
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
	...
	class Turrets : Turrets
	{
		class MainTurret : MainTurret
		{
			...
			gunnerType = "SEP_B_GER_Volk_Militia_G98";
		};
		class CommanderOptics: CommanderOptics
		{
			gunnerType = "SEP_B_GER_Volk_SL";
		};
		class CargoTurret_01: CargoTurret_01
		{
			gunnerType = "SEP_B_GER_Volk_Militia_K98";
		};				
		class CargoTurret_02: CargoTurret_02
		{
			gunnerType = "SEP_B_GER_Volk_Militia_G98";
		...
		class CargoTurret_03: CargoTurret_03
		{
			gunnerType = "SEP_B_GER_Volk_Rflmn";
		};
	};
};

class SEP_B_GER_Volk_SearchLight : SPE_GER_SearchLight
{
	scope=2;
	scopeCurator=2;
	dlc="SEP_B_GER";
	...
	crew="SEP_B_GER_Volk_Militia_G98";
	displayName = "Search Light";
	editorPreview = "\WW2\SPE_Core_t\EditorPreviews_t\SPE_GER_SearchLight.jpg";
};	