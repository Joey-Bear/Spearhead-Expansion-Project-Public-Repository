	...
	class SEP_WP_Static_RKWerfer43_base: SPE_Pak40_base
	{
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				magazines[] = {"SEP_30rnd_RpzBGr4312"};
		...
		class TextureSources
		{
			...
			class SEP_B_GER_Camo2
			{
				displayName = "Dunkelgelb (Camo 02)";
				author = "Jamie";
				textures[] =
				{
			...
			class SEP_B_GER_Camo3
			{
				displayName = "Dunkelgelb (Camo 03)";
				author = "Jamie";
				textures[] =
				{
			...
			class SEP_B_GER_Camo4
			{
				displayName = "Dunkelgelb (Camo 04)";
				author = "Jamie";
				textures[] =
				{
