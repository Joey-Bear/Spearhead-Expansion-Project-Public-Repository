...
//===================================	
    ...
    class SEP_WP_W_M1917_Enfield: SPE_No3_Mk1_Enfield
    {
		...
		class Library
		{
			libTextDesc="The M1917 Enfield is a bolt-action rifle chambered in .30-06 Springfield with a 5-round internal magazine. An American modification of the Pattern 1914 Enfield, large numbers were sent to Britain under Lend-Lease and issued to the Home Guard during the Second World War. Known for its reliability and robust design, it served as a stopgap rifle while more modern weapons were in short supply.";
		};
    };
};