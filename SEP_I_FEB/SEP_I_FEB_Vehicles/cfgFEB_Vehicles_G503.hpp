...
class SEP_I_FEB_G503_MB : SPE_G503_MB_Unarmed_base 
{
	author = "Joe";
...
class SEP_I_FEB_G503_MB_M1919 : SPE_US_G503_MB_M1919_base 
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
...
class SEP_I_FEB_G503_MB_Armoured : SPE_G503_MB_Armoured_base 
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
...
class SEP_I_FEB_G503_MB_M1919_Armoured : SPE_US_G503_MB_M1919_Armoured_base 
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
...
class SEP_I_FEB_G503_MB_Ambulance : SPE_G503_MB_Ambulance_base 
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
...
class SEP_I_FEB_G503_MB_Open : SPE_G503_MB_Open_base 
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
