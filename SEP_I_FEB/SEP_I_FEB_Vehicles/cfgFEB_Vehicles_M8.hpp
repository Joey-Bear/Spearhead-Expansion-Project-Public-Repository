...
class SEP_I_FEB_M20_AUC : SPE_M20_AUC
{
	...
	side = 2;
	editorPreview = "\SEP_I_FEB\SEP_I_FEB_Vehicles\data\editorPreviews\SEP_I_FEB_M20_AUC.jpg";
	...
	hiddenSelectionsTextures[] = 
	{
		...
		"\SEP_I_FEB\SEP_I_FEB_Vehicles\data\SEP_I_FEB_M8_20_Decals_ca.paa",//Decals
...
class SEP_I_FEB_M8_LAC : SPE_M8_LAC
{
	...
	side = 2;
	editorPreview = "\SEP_I_FEB\SEP_I_FEB_Vehicles\data\editorPreviews\SEP_I_FEB_M8_LAC.jpg";
	faction = "SEP_I_FEB_Units";
	crew = "SEP_I_FEB_Tank_Crew";
	hiddenSelectionsTextures[] = 
	{
