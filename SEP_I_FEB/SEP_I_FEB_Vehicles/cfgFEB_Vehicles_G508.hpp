//Unarmed
class SPE_CCKW_353;
class SEP_I_FEB_CCKW_353 : SPE_CCKW_353
{
	author = "Joe";
...
class SEP_I_FEB_CCKW_353_Open : SPE_CCKW_353_Open
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
...
class SEP_I_FEB_CCKW_353_M2 : SPE_CCKW_353_M2
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
...
class SEP_I_FEB_CCKW_353_Ambulance : SPE_CCKW_353_Ambulance
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
...
class SEP_I_FEB_CCKW_353_Ammo : SPE_CCKW_353_Ammo
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
...
class SEP_I_FEB_CCKW_353_Fuel : SPE_CCKW_353_Fuel
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
...
class SEP_I_FEB_CCKW_353_Repair : SPE_CCKW_353_Repair
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
