//M20 AUC
class SPE_M20_AUC;
class SEP_I_RAR_M20_AUC : SPE_M20_AUC
{
	author = "Joe";
	...
	side = 2;
	editorPreview = "\SEP_I_RAR\SEP_I_RAR_Vehicles\data\editorPreviews\SEP_I_RAR_M20_AUC.jpg";
	faction = "SEP_I_RAR_Units";
	crew = "SEP_I_RAR_Tank_Crew";
	...
	class Turrets : Turrets
	{
		...
		{
			gunnerType = "SEP_I_RAR_Tank_Sergeant";
		};
		class kurs_MG_turret : kurs_MG_turret { gunnerType = "SEP_I_RAR_Tank_Crew"; };
...
class SPE_M8_LAC;
class SEP_I_RAR_M8_LAC : SPE_M8_LAC
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
	...
	side = 2;
	editorPreview = "\SEP_I_RAR\SEP_I_RAR_Vehicles\data\editorPreviews\SEP_I_RAR_M8_LAC.jpg";
	faction = "SEP_I_RAR_Units";
	crew = "SEP_I_RAR_Tank_Crew";
	hiddenSelectionsTextures[] = 
	{
...
class SEP_I_RAR_M8_LAC_ringMount : SPE_M8_LAC_ringMount
{
	author = "Joe";
	editorSubcategory = "EdSubcat_Cars";
	scope = 2;
