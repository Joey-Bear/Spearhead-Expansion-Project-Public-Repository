...
class SEP_I_IHTC_M20_AUC : SPE_M20_AUC
{
	...
	side = 2;
	editorPreview = "\SEP\SEP_I_IHTC\SEP_I_IHTC_Vehicles\data\editorPreviews\SEP_I_IHTC_M20_AUC.jpg";
	...
	hiddenSelectionsTextures[] = 
	{
		...
		"\SEP\SEP_I_IHTC\SEP_I_IHTC_Vehicles\data\SEP_I_IHTC_M8_20_Decals_ca.paa",//Decals
...
class SEP_I_IHTC_M8_LAC : SPE_M8_LAC
{
	...
	side = 2;
	editorPreview = "\SEP\SEP_I_IHTC\SEP_I_IHTC_Vehicles\data\editorPreviews\SEP_I_IHTC_M8_LAC.jpg";
	faction = "SEP_I_IHTC_Units";
	crew = "SEP_I_IHTC_Tank_Crew";
	hiddenSelectionsTextures[] = 
	{
