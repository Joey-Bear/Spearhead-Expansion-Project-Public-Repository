...
class SEP_I_IHTC_M3_Halftrack : SPE_Halftrack_base 
{
	...
	side = 2;
	editorPreview = "\SEP_I_IHTC\SEP_I_IHTC_Vehicles\data\editorPreviews\SEP_I_IHTC_M3_Halftrack.jpg";
...
class SEP_I_IHTC_M3_Halftrack_Open : SPE_US_M3_Halftrack_Unarmed_Open 
{
	...
	editorPreview = "\SEP_I_IHTC\SEP_I_IHTC_Vehicles\data\editorPreviews\SEP_I_IHTC_M3_Halftrack_Open.jpg";
	side = 2;
	faction = "SEP_I_IHTC_Units";
	crew = "SEP_I_IHTC_Rflmn_Carb";
	animationList[] = 
...
class SEP_I_IHTC_M3A1_Halftrack : SPE_M3A1_Halftrack_base 
{
	...
	editorPreview = "\SEP_I_IHTC\SEP_I_IHTC_Vehicles\data\editorPreviews\SEP_I_IHTC_M3A1_Halftrack.jpg";
	side = 2;
	faction = "SEP_I_IHTC_Units";
	crew = "SEP_I_IHTC_Rflmn_Carb";
	hiddenSelectionsTextures[] = 
...
class SEP_I_IHTC_M3_Halftrack_Ambulance : SPE_US_M3_Halftrack_Ambulance 
{
	...
	editorPreview = "\SEP_I_IHTC\SEP_I_IHTC_Vehicles\data\editorPreviews\SEP_I_IHTC_M3_Halftrack_Ambulance.jpg";
	side = 2;
	faction = "SEP_I_IHTC_Units";
...
class SEP_I_IHTC_M3_Halftrack_Ammo : SPE_US_M3_Halftrack_Ammo 
{
	...
	editorPreview = "\SEP_I_IHTC\SEP_I_IHTC_Vehicles\data\editorPreviews\SEP_I_IHTC_M3_Halftrack_Ammo.jpg";
	side = 2;
	faction = "SEP_I_IHTC_Units";
	crew = "SEP_I_IHTC_Rflmn_Carb";
	hiddenSelectionsTextures[] = 
...
class SEP_I_IHTC_M3_Halftrack_Fuel : SPE_US_M3_Halftrack_Fuel 
{
	...
	editorPreview = "\SEP_I_IHTC\SEP_I_IHTC_Vehicles\data\editorPreviews\SEP_I_IHTC_M3_Halftrack_Fuel.jpg";
	side = 2;
	faction = "SEP_I_IHTC_Units";
	crew = "SEP_I_IHTC_Rflmn_Carb";
	hiddenSelectionsTextures[] = 
...
class SEP_I_IHTC_M3_Halftrack_Repair : SPE_US_M3_Halftrack_Repair 
{
	...
	editorPreview = "\SEP_I_IHTC\SEP_I_IHTC_Vehicles\data\editorPreviews\SEP_I_IHTC_M3_Halftrack_Repair.jpg";
	side = 2;
	faction = "SEP_I_IHTC_Units";
