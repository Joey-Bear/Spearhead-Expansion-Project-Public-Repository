...
class SEP_I_US_WIN_M3_Halftrack : SPE_Halftrack_base 
{
	author = "Joe";
...
class SEP_I_US_WIN_M3_Halftrack_Open : SPE_US_M3_Halftrack_Unarmed_Open 
{
	author = "Joe";
	editorSubCategory = "EdSubcat_APCs";
	scope = 2;
...
class SEP_I_US_WIN_M3A1_Halftrack : SPE_M3A1_Halftrack_base 
{
	author = "Joe";
	editorSubCategory = "EdSubcat_APCs";
	scope = 2;
	...
	class Turrets : Turrets 
	{
		...
		{ 
			gunnerType = "SEP_I_US_WIN_Driver"; 
		};
...
class SEP_I_US_WIN_M3_Halftrack_Ambulance : SPE_US_M3_Halftrack_Ambulance 
{
	author = "Joe";
	editorSubCategory = "EdSubcat_APCs";
	scope = 2;
...
class SEP_I_US_WIN_M3_Halftrack_Ammo : SPE_US_M3_Halftrack_Ammo 
{
	author = "Joe";
	editorSubCategory = "EdSubcat_APCs";
	scope = 2;
...
class SEP_I_US_WIN_M3_Halftrack_Fuel : SPE_US_M3_Halftrack_Fuel 
{
	author = "Joe";
	editorSubCategory = "EdSubcat_APCs";
	scope = 2;
...
class SEP_I_US_WIN_M3_Halftrack_Repair : SPE_US_M3_Halftrack_Repair 
{
	author = "Joe";
	editorSubCategory = "EdSubcat_APCs";
	scope = 2;
...
class SPE_US_M16_Halftrack_base;
class SEP_I_US_WIN_M16_Halftrack : SPE_US_M16_Halftrack_base 
{
	author = "Joe";
	editorSubCategory = "EdSubcat_APCs";
	scope = 2;
