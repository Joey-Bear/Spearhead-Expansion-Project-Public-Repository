class CfgPatches 
{
	...
	class SEP_WP_APLND_Gewehr98 
	{
		...
		weapons[] = 
		{
			...
			"SEP_WP_Gewehr98_Bayo",
			"SEP_WP_ACC_Gewehr98_Bayo",
			"SEP_WP_ACC_Gewehr9805_Bayo"
		};
...
{
	//* Bases *//
	class SEP_WP_ACC_Gewehr98_Bayo: SPE_ACC_Bayonet_Base
	{
		author = "Joe";
		displayName = "Seitengewehr 98 Bayonet";
		SPE_AttachmentType = "SPE_fixedBayonet";
		SPE_bayonetLength = 65;
		weaponInfoType = "SPE_Rsc_Bayonet_Zeroing";
		model = "\SEP_WP_APLND\SEP_WP_APLND_Gewehr98\Seitengewehr98.p3d";
		picture = "\WW2\SPE_Assets_t\Weapons\Equipment_t\Weapons\MuzzleItem\Gear_ACC_K98_Bayo_ca.paa";
		scope = 2;
	};

	class SEP_WP_ACC_Gewehr9805_Bayo: SPE_ACC_Bayonet_Base
	{
		author = "Joe";
		displayName = "Seitengewehr 98/05 Bayonet";
		SPE_AttachmentType = "SPE_fixedBayonet";
		SPE_bayonetLength = 35;
		weaponInfoType = "SPE_Rsc_Bayonet_Zeroing";
		model = "\SEP_WP_APLND\SEP_WP_APLND_Gewehr98\Seitengewehr9805.p3d";
		picture = "\WW2\SPE_Assets_t\Weapons\Equipment_t\Weapons\MuzzleItem\Gear_ACC_K98_Bayo_ca.paa";
		scope = 2;
	};
	
    /* Arsenal */
	class SEP_WP_Gewehr98: SPE_RIFLE
    {
		...
		class WeaponSlotsInfo: WeaponSlotsInfo
    	{
			...
			class MuzzleSlot
			{
				compatibleItems[] = {"SEP_WP_ACC_Gewehr98_Bayo","SEP_WP_ACC_Gewehr9805_Bayo"};
				iconPicture = "\A3\Weapons_F\Data\UI\attachment_muzzle.paa";
				iconPinpoint = "center";
				iconPosition[] = {-0.025,0.375};
				iconScale = 0.16;
	...
	class SEP_WP_Gewehr98_Sniper: SEP_WP_Gewehr98
    {
		...
		class Library
		{
			libTextDesc = "First issued in the spring of 1915, the sniper variant of the Gewehr 98 was outfitted a telescopic sight for precision shooting, typically a 4x Görtz or Zeiss, or in many cases the Luxor 3x. These rifles saw service with German marksmen during the First World War and, in smaller numbers, during the Second World War.";
		};
	...
	class SEP_WP_Gewehr98_Bayo: SEP_WP_Gewehr98
    {
	baseWeapon = "SEP_WP_Gewehr98";
	muzzles[] = 
	{
		"this",
		"SPE_Bayonet_Muzzle"
	};
	class SPE_Bayonet_Muzzle: SPE_Bayonet_base
		{
			displayName = "Bayonet";
		};
		class LinkedItems
